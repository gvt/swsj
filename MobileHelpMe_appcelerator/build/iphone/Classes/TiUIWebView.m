...
NSString * const kMobileHelpMe_appceleratorJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_mobilehelpme_appceleratorInjection
{
	...
	[html appendString:kMobileHelpMe_appceleratorJavascript];
...
{
	// attempt to make well-formed HTML and inject in our MobileHelpMe_appcelerator bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _mobilehelpme_appceleratorInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to MobileHelpMe_appcelerator support.",url);
				}
			}

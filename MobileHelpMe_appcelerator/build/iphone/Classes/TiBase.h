...
// in simulator we redefine to format for MobileHelpMe_appcelerator Developer console
...
{\
	NSString * exceptionName = [@"org.mobilehelpme_appcelerator." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mobilehelpme_appcelerator";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMobileHelpMe_appceleratorNativeItemNone = -1, 
	UIMobileHelpMe_appceleratorNativeItemSpinner = -2,
	UIMobileHelpMe_appceleratorNativeItemProgressBar = -3,
	
	UIMobileHelpMe_appceleratorNativeItemSlider = -4,
	UIMobileHelpMe_appceleratorNativeItemSwitch = -5,
	UIMobileHelpMe_appceleratorNativeItemMultiButton = -6,
	UIMobileHelpMe_appceleratorNativeItemSegmented = -7,
	
	UIMobileHelpMe_appceleratorNativeItemTextView = -8,
	UIMobileHelpMe_appceleratorNativeItemTextField = -9,
	UIMobileHelpMe_appceleratorNativeItemSearchBar = -10,
	
	UIMobileHelpMe_appceleratorNativeItemPicker = -11,
	UIMobileHelpMe_appceleratorNativeItemDatePicker = -12,
	
	UIMobileHelpMe_appceleratorNativeItemInfoLight = -13,
	UIMobileHelpMe_appceleratorNativeItemInfoDark = -14,
	
	UIMobileHelpMe_appceleratorNativeItemDisclosure = -15,
	
	UIMobileHelpMe_appceleratorNativeItemContactAdd = -16
};
